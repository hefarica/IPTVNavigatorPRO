...
(function () {
    ...
    function generateStaticAPEGlobalBlock() {
        return [
            ...
            '#EXT-X-CORTEX-AV1-DEBLOCKING:MAXIMUM_ATTENUATION',
            '#EXT-X-CORTEX-AV1-CDEF:ENABLED_DIRECTIONAL_RESTORATION',
            '#EXT-X-CORTEX-VVC-VIRTUAL-BOUNDARIES:EDGE_ARTIFACT_SUPPRESSION',
            ...
            '#EXT-X-APE-FALLBACK-AUTH-PERSIST:true',
            '#EXT-X-APE-FALLBACK-ID:407_PROXY_NUCLEAR',
            ...
            '#EXT-X-APE-FALLBACK-407-PERSIST:INSIST_FOREVER',
            '#EXT-X-APE-FALLBACK-ID:503_DEGRADE_PERSIST',
            '#EXT-X-APE-FALLBACK-CONNECTION:close',
            '#EXT-X-APE-FALLBACK-ACCEPT:video/mp2t',
            '#EXT-X-APE-FALLBACK-PROTOCOL-CHAIN:HLS,DASH,TS-DIRECT,HTTP-REDIRECT',
            '#EXT-X-APE-FALLBACK-503-PERSIST:DEGRADE_NEVER_STOP',
            '#EXT-X-APE-FALLBACK-ID:504_TIMEOUT_ASSAULT',
            '#EXT-X-APE-FALLBACK-KEEP-ALIVE:timeout=300,max=1000',
            '#EXT-X-APE-FALLBACK-504-RETRY:10',
            '#EXT-X-APE-FALLBACK-504-PERSIST:ASSAULT_UNTIL_OPEN',
            '#EXT-X-APE-FALLBACK-ID:3XX_REDIRECT_FOLLOW',
            '#EXT-X-APE-FALLBACK-FOLLOW-REDIRECTS:true',
            '#EXT-X-APE-FALLBACK-MAX-REDIRECTS:10',
            '#EXT-X-APE-FALLBACK-REDIRECT-AUTH-PRESERVE:true',
            '#EXT-X-APE-EVASION-ENGINE:POLYMORPHIC_v22.2',
            '#EXT-X-APE-EVASION-PERSIST:INFINITE',
            '#EXT-X-APE-EVASION-MUTATION-RATE:PER_REQUEST',
            '#EXT-X-APE-IP-ROTATION-POOL-SIZE:50',
            '#EXT-X-APE-IP-ROTATION-PERSIST:PER_SESSION'
        ].join('\n');
    }

    // Directiva 2: Static EXTHTTP headers (declared once globally as base64)
    function generateStaticEXTHTTPGlobal() {
        const staticHeaders = {
            ...
            "X-Quality-Preference": "codec-av1,profile-main-12,main-10,main,tier-high;codec-hevc,main-10",
        ...
        const json = JSON.stringify(staticHeaders);
        const b64 = typeof btoa === 'function' ? btoa(json) : Buffer.from(json).toString('base64');
        return `#EXT-X-APE-STATIC-EXTHTTP-B64:${b64}`;
    }
...
#EXT-X-APE-OPTIMIZATION:GLOBALIZED_STATIC_TAGS_v1
${generateStaticAPEGlobalBlock()}
${generateStaticEXTHTTPGlobal()}`;
    }
